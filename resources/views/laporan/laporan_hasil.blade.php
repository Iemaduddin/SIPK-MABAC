    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Laporan Hasil Perhitungan</h3>
                <p class="text-subtitle text-muted">Cetak Hasil Laporan Perhitungan Peminjaman</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard_operator') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Laporan Perhitungan</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card-body shadow">
                <div class="nav nav-tabs col-lg-12 d-flex justify-content-center" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link me-3" id="nav-ranking-alternatif" data-bs-toggle="tab"
                        ...
                        aria-controls="nav-rankingAlternatif" aria-selected="false">Ranking</button>
